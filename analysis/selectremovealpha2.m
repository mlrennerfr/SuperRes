...
% function vect2remove=selectremovealpha2(handles,x,y,alpha)
% Modified from PALMvis
% Marianne Renner - incorporated into SuperRes programs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
percalphamin = str2num(get(handles.alpha1,'String'));
percalphamax = str2num(get(handles.alpha2,'String'));
