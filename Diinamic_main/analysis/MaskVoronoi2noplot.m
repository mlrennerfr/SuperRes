function [surfacearea, mask]=MaskVoronoi2noplot(fondo,roiselectedx,roiselectedy,limitarea)
%function [surfacearea, mask]=MaskVoronoi2noplot(fondo,roiselectedx,roiselectedy,limitarea)
%
...
% Marianne Renner version for dinamicGTvoro.m 04/23
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if isempty(selecregions)
    mask=fondob;
else
    
    aux=fondob;
    for kk=1:size(selecregions,1) %length(selecregions)
...
clear patch selecregions fondo fondob positions v c polyarea gg
